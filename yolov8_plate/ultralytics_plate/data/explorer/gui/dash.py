...
from ultralytics_plate import Explorer
from ultralytics_plate.utils import ROOT, SETTINGS
from ultralytics_plate.utils.checks import check_requirements
...
def utralytics_explorer_docs_callback():
    ...
    with st.container(border=True):
        st.image(
            "https://raw.githubusercontent.com/ultralytics_plate/assets/main/logo/ultralytics_plate_Logotype_Original.svg",
            width=100,
        )
        st.markdown(
            "<p>This demo is built using ultralytics_plate Explorer API. Visit <a href='https://docs.ultralytics_plate.com/datasets/explorer/'>API docs</a> to try examples & learn more</p>",
            unsafe_allow_html=True,
            help=None,
        )
        st.link_button("Ultrlaytics Explorer API", "https://docs.ultralytics_plate.com/datasets/explorer/")


def layout():
    """Resets explorer session variables and provides documentation with a link to API docs."""
    st.set_page_config(layout="wide", initial_sidebar_state="collapsed")
    st.markdown("<h1 style='text-align: center;'>ultralytics_plate Explorer Demo</h1>", unsafe_allow_html=True)
