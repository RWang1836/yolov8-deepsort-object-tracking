...
Requirements:
    $ pip install "ultralytics_plate_plate[export]"
...
from ultralytics_plate.cfg import get_cfg
from ultralytics_plate.data.dataset import YOLODataset
from ultralytics_plate.data.utils import check_det_dataset
from ultralytics_plate.nn.autobackend import check_class_names, default_class_names
from ultralytics_plate.nn.modules import C2f, Detect, RTDETRDecoder
from ultralytics_plate.nn.tasks import DetectionModel, SegmentationModel
...
from ultralytics_plate.utils.checks import check_imgsz, check_is_path_safe, check_requirements, check_version
from ultralytics_plate.utils.downloads import attempt_download_asset, get_github_assets
from ultralytics_plate.utils.files import file_size, spaces_in_path
from ultralytics_plate.utils.ops import Profile
from ultralytics_plate.utils.torch_utils import get_latest_opset, select_device, smart_inference_mode
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        description = f'ultralytics_plate {self.pretty_name} model {f"trained on {data}" if data else ""}'
        self.metadata = {
            "description": description,
            "author": "ultralytics_plate",
            "license": "AGPL-3.0 https://ultralytics_plate.com/license",
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        ...
        f_onnx, _ = self.export_onnx()  # run before trt import https://github.com/ultralytics_plate/ultralytics_plate/issues/7016
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        check_version(
            ...
            name="tensorflow",
            verbose=True,
            msg="https://github.com/ultralytics_plate/ultralytics_plate/issues/5161",
        )
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        ...
        LOGGER.warning(f"{prefix} WARNING ⚠️ Edge TPU known bug https://github.com/ultralytics_plate/ultralytics_plate/issues/1185")
...
class IOSDetectModel(torch.nn.Module):
    """Wrap an ultralytics_plate YOLO model for Apple iOS CoreML export."""
