...
from ultralytics_plate.models.fastsam.utils import bbox_iou
...
class FastSAMPredictor(DetectionPredictor):
    """
    FastSAMPredictor is specialized for fast SAM (Segment Anything Model) segmentation prediction tasks in ultralytics_plate
    YOLO framework.
