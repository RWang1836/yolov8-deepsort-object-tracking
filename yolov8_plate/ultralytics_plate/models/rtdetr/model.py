...
from ultralytics_plate.nn.tasks import RTDETRDetectionModel
...
class RTDETR(Model):
    ...
    def task_map(self) -> dict:
        """
        Returns a task map for RT-DETR, associating tasks with corresponding ultralytics_plate classes.

        Returns:
            dict: A dictionary mapping task names to ultralytics_plate task classes for the RT-DETR model.
        """
        return {
            "detect": {
