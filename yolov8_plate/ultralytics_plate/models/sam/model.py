...
This module provides an interface to the Segment Anything Model (SAM) from ultralytics_plate, designed for real-time image
...
from ultralytics_plate.utils.torch_utils import model_info
