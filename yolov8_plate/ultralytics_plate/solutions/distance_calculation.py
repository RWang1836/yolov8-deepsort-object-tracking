...
from ultralytics_plate.utils.checks import check_imshow
...
class DistanceCalculation:
    ...
    def display_frames(self):
        """Display frame."""
        cv2.namedWindow("ultralytics_plate Distance Estimation")
        cv2.setMouseCallback("ultralytics_plate Distance Estimation", self.mouse_event_for_distance)
        cv2.imshow("ultralytics_plate Distance Estimation", self.im0)
