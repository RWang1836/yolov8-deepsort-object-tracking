...
Usage:
    from ultralytics_plate_plate.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics_plate.cfg import TASK2DATA, TASK2METRIC
from ultralytics_plate.engine.exporter import export_formats
from ultralytics_plate.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from ultralytics_plate.utils.checks import check_requirements, check_yolo
from ultralytics_plate.utils.files import file_size
...
def benchmark(
    ...
    Example:
        ```python
        from ultralytics_plate_plate.utils.benchmarks import benchmark
...
class ProfileModels:
    ...
    Example:
        ```python
        from ultralytics_plate_plate.utils.benchmarks import ProfileModels
