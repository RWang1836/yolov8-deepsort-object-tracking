...
from ultralytics_plate.utils import LOGGER, SimpleClass, TryExcept, plt_settings
...
def smooth_BCE(eps=0.1):
    ...
    For implementation details, refer to https://github.com/ultralytics_plate/yolov3/issues/238#issuecomment-598028441.
